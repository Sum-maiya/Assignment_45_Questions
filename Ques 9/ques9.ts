...
// Program by [Summaiya Riaz]
// Date: [31-08-2023]
// This program stores and displays a favorite number using a variable and a message.

let favoriteNumber = 38; // Store your favorite number here
let message = `My favorite number is ${favoriteNumber}.`; // Create a message using the favorite number
console.log(message); // Output: My favorite number is 38.
