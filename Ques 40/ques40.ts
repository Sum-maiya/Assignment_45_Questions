...
// Example 1: Album without specifying the number of tracks
const album1 = make_album("Artist 1", "Album Title 1");
console.log(album1);

// Example 2: Album with a specified number of tracks
const album2 = make_album("Artist 2", "Album Title 2", 12);
console.log(album2);

// Example 3: Another album without specifying the number of tracks
